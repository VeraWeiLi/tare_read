...
namespace lidar_model_ns
{
    ...
    public:
        ...
        explicit LiDARModel(const geometry_msgs::Pose& pose);//pose=point+quaternion
        ~LiDARModel() = default;
    ...
    private:
        ...
        // Constant converting radian to degree 将弧度转换为度
        ...
        // Ratio for inflating the cloud  膨胀云层的比率
        static const double kCloudInflateRatio;
        // Horizontal field-of-view in degrees    以度为单位的水平视野，也就是这个雷达是360°看周围的
        static const int kHorizontalFOV = 360;
        // Vertical field-of-view in degrees   垂直视野 垂直视角是学生注视黑板上缘的视线与黑板面垂直线所构成的夹角
